        ...
        child: BlocConsumer<Register_Cubit, Register_states>(
          listener: (context, state) {
            if (state is UserCreatesuccessStates) {
              ...
              ShowToast(message:'succces Registiration' , state: ToastColorState.success);
              NavigatorAndFinish(context,Social_home_Screen());
                             }
            else if (state is RegistererrorStates) {
              ShowToast(
                    state: ToastColorState.error, message: 'Not Allowed Registiration');
              }
            },
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Register now to communicate with your friends',
                          style: TextStyle(
