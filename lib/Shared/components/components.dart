...
Future NavigatorAndFinish(context,Widget) => Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder:(context)=> Widget),
...
class clipperPathBuilder extends CustomClipper<Path>{
  ...
  Path getClip(Size size) {
    Path path=Path();
    path.addOval(Rect.fromCircle(center: Offset(DxOfOffset,DyOfOffset),radius: radius));
    return path;
  }
